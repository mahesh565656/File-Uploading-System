  ...
  <main class="main-container">
    <section class="content-container">
      <div class="sidebar">
        <div class="menu">
          <div class="links">
            <ul><a href="StudyBuddy Backend/syllabus.html" style="text-decoration:none;">
                <div class="link">
                  <li>SGBAU-Syllabus</li>
                </div>
              </a>

              <a href="StudyBuddy Backend/selectyear.html" style="text-decoration:none;">
                <div class="link">
                  <li>SGBAU-PYQ Papers</li>
                </div>
              </a>

              <a href="StudyBuddy Backend/notes.html" style="text-decoration:none;">
                <div class="link">
                  <li>Notes</li>
                </div>
              </a>

              <a href="StudyBuddy Backend/imp.html" style="text-decoration:none;">
                <div class="link">
                  <li>IMP Topics</li>
                </div>
              </a>

              <a href="StudyBuddy Backend/programming.html" style="text-decoration:none;">
                <div class="link">
              ...
              <div class="link">
                <li>C language Notes</li>
              </div>
              <div class="link">
                <li>C++ language Notes</li>
              </div>
              <div class="link">
                <li>JAVA language Notes</li>
              </div>
              <div class="link">
                <li>Python language Notes</li>
              </div>
              <div class="link">
                <li>HTML</li>
              </div>
...
-->
        ...
        <div class="posts">
          <?php
          $result = mysqli_query($conn, "SELECT * FROM notesdata");
              ...
              <article class="post">
                <div class="post__header">
                  <div class="post__profile">
                    <a href="https://github.com/leocosta1" target="_blank" class="post__avatar">
                      <img src="<?php echo $row['image']; ?>" alt="User Picture" />
                    </a>
                    <a href="https://github.com/leocosta1" target="_blank" class="post__user"></a>
                  </div>
                ...
                <div class="post__content">
                  <div class="post__medias">
                    <img class="post__media" src="<?php echo $row['image']; ?>" alt="Post Content" />
                  </div>
                </div>
...
-->
                    <div class="post__description">
                      <span>
                        <a class="post__name--underline" href="https://github.com/leocosta1" target="_blank"><?php echo $row['name']; ?></a><br>
                        <?php echo $row['description']; ?>
                      </span>
                    </div>

                    <span class="post__date-time">Subject :<?php echo $row['subject']; ?></span>
                  </div>
                </div>
              </article>
    ...
    ?>
          ...
          <div class="side-menu__user-info">
            <a href="https://github.com/leocosta1" target="_blank"><?php // echo  $row['image']; ?></a>
  ...
  <nav class="navbar">
    ...
    <a href="searchpage.html" class="navbar__button">
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <a href="upload.php" class="navbar__button">
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
